...
class SendsmsWidget extends StatefulWidget {
  ...
  const SendsmsWidget({Key? key, required this.patientId}) : super(key: key);
  @override
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            if (patientData[0]['email'] == null ||
                patientData[0]['paitentid'] == null) {
              return Center(child: Text('Patient data is incomplete.'));
            }

            // Extract email and patient ID
            String email = patientData[0]['email'];
            String patientID = patientData[0]['paitentid'];

            // Construct email subject and body
            String subject = "Patient ID";
            String body = "This is your Patient ID: $patientID";
